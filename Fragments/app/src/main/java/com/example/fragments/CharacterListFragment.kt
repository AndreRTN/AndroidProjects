...
class CharacterListFragment : Fragment() {
    ...
    internal inner class CharacterListAdapter : RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
            val character = com.example.fragments.Character(
                names[position],
    ...
    internal inner class ViewHolder constructor(itemView: View) :
        ...
        fun bind(character: com.example.fragments.Character) {
    ...
    interface OnListSelected {
        fun onSelected(character: com.example.fragments.Character)
    }
